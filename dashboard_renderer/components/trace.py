"""dashboard_renderer.components.trace — Phase 17 Inputs/Indicators/Vote panels.

Phase 32 Plan 02: ported VERBATIM from dashboard_legacy/trace_panels.py.
