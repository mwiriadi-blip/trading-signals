...
from dashboard_renderer.components.calc_rows import (
  _render_calc_row,
...
from dashboard_renderer.stats import (
  compute_trail_stop_display as _compute_trail_stop_display,
  compute_unrealised_pnl_display as _compute_unrealised_pnl_display_raw,
)
from dashboard_renderer.formatters import _CONTRACT_SPECS
...
def _compute_unrealised_pnl_display(
  ...
  '''Thin adapter: matches the 4-arg legacy signature, forwarding to the
  canonical 5-arg dashboard_renderer.stats version.
  '''
