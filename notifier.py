...
'''
import html
import json as _json_phase27_11  # Plan 27-11 — aliased to dodge name collisions
import logging
import os
import re as _re_phase27_11  # Plan 27-11 — aliased to dodge name collisions
import tempfile
import time
...
# dashboard visit via LAST_CRASH_PATH on disk. Review-fix agreed-5:
#   - Path is configurable (LAST_CRASH_PATH env var); defaults to
#     LAST_CRASH_FILE next to STATE_FILE — NOT a separate working location.
