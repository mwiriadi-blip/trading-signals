...
- [x] **WEB-01
**: FastAPI app runs as a separate systemd unit (`trading-signals-web`) on the droplet and starts on boot
- [x] **WEB-02
**: uvicorn serves the app on `localhost:8000`; nginx reverse-proxies from port 443 → 8000
