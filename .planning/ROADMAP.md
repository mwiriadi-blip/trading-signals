...
**Plans:** 3 plans (regenerated 2026-04-29 per F-09 Option B; superseded prior 2 stale plans archived to `.archive/`) — **ALL 3 EXECUTED + VERIFIED 2026-04-29 (operator UAT pending — see 16.1-HUMAN-UAT.md UAT-16.1-A..G)**
  - [x] `16.1-01-PLAN.md` — Cookie login + TOTP enrollment + TOTP verify + auth_store.py + middleware E-02 3-step sniff (E-01 Basic Auth removed, E-02, E-03, E-04, AUTH-04..09, AUTH-12) ✓ 2026-04-29 (commits 34b709a..3a8b216)
  - [x] `16.1-02-PLAN.md` — Trusted-device cookie (30-day) + /devices revocation page + per-device label (E-05, E-06, AUTH-09 trust-skip + AUTH-10) — depends on 16.1-01 ✓ 2026-04-29 (commits 917d889..fd139fc)
  - [x] `16.1-03-PLAN.md` — Magic-link reset (email via Resend, sha256-hashed tokens, 1h TTL) + rate limits (F-08) + OPERATOR_RECOVERY_EMAIL boot validation + 16.1-HUMAN-UAT.md (E-07, F-01..F-08, AUTH-11) — depends on 16.1-01 ✓ 2026-04-29 (commits 4fda67a..d4940d2; verifier 5e77154)
**Plans (wave structure)**: Wave 1 = [16.1-01] sequential (core auth path — middleware diff is shared state with downstream plans per .claude/LEARNINGS.md 2026-04-27 entry); Wave 2 = [16.1-02] after 16.1-01; Wave 3 = [16.1-03] sequential — Plan 03 depends on Plan 02 (shared auth_store.py + web/routes/totp.py per LEARNINGS 2026-04-27 "shared function body = sequential"; revised 2026-04-29 from prior "could parallelize" wording per BLOCKER-04 fix).
