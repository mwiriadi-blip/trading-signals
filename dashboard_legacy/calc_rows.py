"""dashboard_legacy.calc_rows — calculator + entry-target sub-rows.

Extracted from dashboard.py (Plan 27-14). Phase 15 CALC-01/02/04 — inline
display-math under positions table.
"""
import html
import math
